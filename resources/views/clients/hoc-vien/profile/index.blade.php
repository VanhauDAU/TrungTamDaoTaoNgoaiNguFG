                ...
                <div class="col-lg-9">
                    <div class="account-content">
                        ...
                        <div class="profile-section">
                            ...
                            <x-upload.image
                                action="{{ route('home.student.update-avatar') }}"
                                name="anhDaiDien"
                                title="Đổi ảnh đại diện"
                                description="Nhấn vào ảnh, chọn file hoặc kéo thả trực tiếp. Ảnh xem trước sẽ cập nhật ngay tại chỗ trước khi bạn xác nhận tải lên."
                                choose-label="Chọn ảnh"
                                preview-url="{{ Auth::user()->getAvatarUrl() }}"
                                preview-alt="Ảnh đại diện"
                                preview-shape="circle"
                                sync-selector="[data-avatar-image]"
