                    ...
                    <div class="wizard-panel active" id="panel-1">
                        <div class="nb-card">
                            ...
                            <div class="nb-form-group" style="margin-top:1.25rem;">
                                ...
                                <div class="nb-dropzone" id="nb-dropzone"
                                    onclick="document.getElementById('tepDinhInput').click()"
                                    ...
                                    <div style="font-size:.9rem;color:#6b7280;margin-top:.5rem;">Kéo thả file vào đây hoặc
                                        <span style="color:#6366f1;text-decoration:underline;cursor:pointer;">chọn
                                            file</span>
                                    </div>
                    ...
                    <div class="wizard-panel" id="panel-2">
                        <div class="nb-card">
                            ...
                            <div id="subSelector" class="nb-form-group" style="display:none;">
                                ...
                                <div id="ss-coso" class="ss-panel" style="display:none;">
                                    <label class="nb-form-label">Chọn cơ sở <span class="req">*</span></label>
                            ...
                            <div id="recipientPreview" style="display:none;">
                                ...
                                <div class="preview-body" id="previewBody">
                                    <div class="preview-loading"><i class="fas fa-spinner fa-spin me-1"></i> Đang tải…
                                    </div>
                                </div>
                        ...
                        <div class="nb-card">
                            ...
                            <div class="confirm-preview">
                                ...
                                <div class="cp-meta">
                                    ...
                                    <div class="cp-badge"><i class="fas fa-flag"></i> <span id="cf-uu-tien">—</span>
                                    </div>
                                    <div class="cp-badge"><i class="fas fa-users"></i> <span id="cf-doi-tuong">—</span>
                                    </div>
                                </div>
