    ...
    <form action="{{ route('admin.giao-vien.store') }}" method="POST" id="gv-create-form" autocomplete="off">
        ...
        <div class="gv-header">
            <div class="gv-header-left">
                ...
                <div>
                    <h1 class="gv-header-title">Thêm giáo viên mới</h1>
                    <p class="gv-header-sub">Điền đầy đủ thông tin để tạo hồ sơ giáo viên</p>
                </div>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="cccd">
                                ...
                                <span class="form-hint-inline">(dùng làm mật khẩu tạm)</span>
                            </label>
                        ...
                        <div class="form-group full">
                            <div class="gv-pass-notice">
                                <div class="gv-pass-notice-icon"><i class="fas fa-shield-halved"></i></div>
                                <div class="gv-pass-notice-body">
                                    <strong>Tài khoản &amp; mật khẩu được tạo tự động</strong>
                                    <div class="gv-pass-grid">
                                        <span class="gv-pass-label">Tên đăng nhập:</span>
                                        <code id="username-preview">GV######</code>
                                        <span class="gv-pass-label">Mật khẩu:</span>
                                        <code id="password-preview">theo CCCD (hoặc <strong>12345678</strong> nếu chưa
                                            có)</code>
                                    </div>
                                    <p>Tên đăng nhập sẽ được hệ thống cấp tự động theo mã giáo viên. Giáo viên có thể đổi mật khẩu sau lần đăng nhập đầu tiên.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="ngaySinh" name="ngaySinh"
                                ...
                                value="{{ old('ngaySinh') }}" max="{{ date('Y-m-d') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="zalo" name="zalo" class="form-control"
                                value="{{ old('zalo') }}" placeholder="SĐT Zalo (nếu khác)">
        ...
        <div class="gv-tab-panel" id="tab-staff">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="hocVi" name="hocVi" class="form-control"
                                value="{{ old('hocVi') }}" placeholder="vd: IELTS 8.0, JLPT N1...">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="loaiHopDong" name="loaiHopDong" class="form-control">
                                ...
                                @foreach (['Toàn thời gian', 'Bán thời gian', 'Thỉnh giảng', 'Thử việc'] as $lhd)
                                    <option value="{{ $lhd }}"
                                        {{ old('loaiHopDong') === $lhd ? 'selected' : '' }}>{{ $lhd }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="gv-card gv-card-facility">
                ...
                <div class="gv-card-body">
                    ...
                    <input type="hidden" name="coSoId" id="coSoId" value="{{ old('coSoId') }}">
                    @error('coSoId')
        ...
        <div class="gv-tab-panel" id="tab-note">
            ...
            <div class="gv-tab-footer">
                ...
                <div class="gv-footer-right">
                    <button type="reset" class="gv-btn gv-btn-ghost">
...
@section('script')
    <script>
        ...
        document.getElementById('gv-create-form')?.addEventListener('submit', syncFromCCCD);
