    ...
    <form action="{{ route('admin.danh-muc-khoa-hoc.store') }}" method="POST">
        ...
        <div class="dm-card">
            ...
            <div class="dm-form-group">
                ...
                <div class="form-hint" style="margin-top: 4px;font-size:0.8rem">Đường dẫn (slug) sẽ được tự động tạo dựa
                    trên tên danh mục.</div>
                @error('tenDanhMuc')
            ...
            <div class="dm-form-group">
                <label>Mô tả</label>
                <textarea name="moTa" rows="4" placeholder="Mô tả ngắn về danh mục này...">{{ old('moTa') }}</textarea>
                @error('moTa')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
