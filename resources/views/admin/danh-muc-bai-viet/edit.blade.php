            ...
            <div class="dm-form-row">
                <div class="dm-form-group" style="grid-column: 1/-1">
                    ...
                    <input type="text" name="tenDanhMuc" value="{{ old('tenDanhMuc', $danhMuc->tenDanhMuc) }}"
                        placeholder="Nhập tên danh mục..." class="{{ $errors->has('tenDanhMuc') ? 'is-invalid' : '' }}">
                    @error('tenDanhMuc')
            ...
            <div class="dm-form-row">
                <div class="dm-form-group" style="grid-column: 1/-1">
                    ...
                    <textarea name="moTa" rows="3"
                        placeholder="Mô tả ngắn gọn cho danh mục...">{{ old('moTa', $danhMuc->moTa) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="dm-card">
            ...
            <div class="dm-toggle-group">
                <label class="dm-toggle">
                    ...
                    <input type="checkbox" id="trangThaiToggle" value="1" {{ old('trangThai', $danhMuc->trangThai) ? 'checked' : '' }}
                ...
                <span class="dm-toggle-label" id="toggle-label">
                    {{ old('trangThai', $danhMuc->trangThai) ? 'Đang hoạt động' : 'Ngừng hoạt động' }}
                </span>
            </div>
        </div>
