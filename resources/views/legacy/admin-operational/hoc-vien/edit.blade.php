...
@section('content')
    ...
    <form action="{{ route($portalRouteBase . '.hoc-vien.update', $hocVien->taiKhoan) }}" method="POST" id="hv-edit-form" class="needs-validation" novalidate data-joi-schema="hocVien"
        ...
        <div class="hv-create-header">
            ...
            <div class="hv-breadcrumb-actions">
                <a href="{{ route($portalRouteBase . '.hoc-vien.index') }}" class="btn-back">
...
@section('script')
    ...
    @include('legacy.admin-operational.hoc-vien.partials.citizen-lookup-script')
@endsection
