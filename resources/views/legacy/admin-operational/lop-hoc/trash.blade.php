...
@section('content')
    ...
    <div class="lh-page-header">
        ...
        <div style="display:flex;gap:10px;align-items:center">
            <a href="{{ route($portalRouteBase . '.lop-hoc.index') }}" class="btn-add-lh" style="background:#64748b">
    ...
    <form action="{{ route($portalRouteBase . '.lop-hoc.trash') }}" method="GET" class="lh-filter-bar" id="lh-filter-form">
        ...
        <a href="{{ route($portalRouteBase . '.lop-hoc.trash') }}" class="lh-btn-filter lh-btn-filter-reset">
                            ...
                            <tr style="opacity:.86">
                                ...
                                <td style="text-align:center">
                                    <button type="button"
                                        ...
                                        data-restore-url="{{ route($portalRouteBase . '.lop-hoc.restore', $lop->slug) }}"
