...
@section('content')
    ...
    <div class="lh-page-header">
        ...
        <div style="display:flex;gap:10px;align-items:center">
            <a href="{{ route($portalRouteBase . '.lop-hoc.trash') }}" class="btn-add-lh"
            ...
            <a href="{{ route($portalRouteBase . '.lop-hoc.create') }}" class="btn-add-lh">
    ...
    {{-- ── Filter bar ────────────────────────────────────────────── --}}
    <form action="{{ route($portalRouteBase . '.lop-hoc.index') }}" method="GET" id="lh-filter-form">
        <div class="lh-filter-advanced">
            <div class="lh-filter-advanced-grid">
                ...
                <div class="lh-filter-actions">
                    ...
                    <a href="{{ route($portalRouteBase . '.lop-hoc.index') }}" class="lh-btn-filter lh-btn-filter-reset">
                        ...
                        @foreach ($lopHocs as $lop)
                            @php
                                ...
                                $allowedTransitions =
                                    ...
                                    [];
                                $canUpdateStatus = count($allowedTransitions) > 1;
                            @endphp
                            <tr>
                                <td style="color:#94a3b8;font-size:.78rem">{{ $lopHocs->firstItem() + $loop->index }}</td>
                                <td>
                                    <a href="{{ route($portalRouteBase . '.lop-hoc.show', $lop->slug) }}"
                                ...
                                <td>
                                    <div class="lh-status-stack">
                                        ...
                                        <select class="lh-status-select js-status-select"
                                            data-update-url="{{ route($portalRouteBase . '.lop-hoc.update-status', $lop->slug) }}"
