...
@section('content')
    ...
    <div class="hv-page-header" style="margin-bottom:16px">
        ...
        <a href="{{ route($portalRouteBase . '.hoc-vien.index') }}" class="btn-back-list">
            <i class="fas fa-arrow-left"></i> Danh sách học viên
        </a>
    </div>

    {{-- ── Search bar ───────────────────────────────────────────────── --}}
    <form action="{{ route($portalRouteBase . '.hoc-vien.trash') }}" method="GET" class="hv-filter-bar" id="filter-form"
        ...
        <a href="{{ route($portalRouteBase . '.hoc-vien.trash') }}" class="btn-filter btn-filter-reset">
    ...
    <div class="hv-card">
        ...
        @if ($hocViens->isEmpty())
            <div class="hv-empty">
                ...
                <a href="{{ route($portalRouteBase . '.hoc-vien.index') }}" class="btn-back-list" style="margin-top:10px">
        ...
        function confirmRestore(id, name) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = `{{ $portalPathBase }}/hoc-vien/${id}/khoi-phuc`;
                    form.submit();
                }
            });
        }
