    ...
    <div class="invoice-page container-fluid px-0">
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4">
                <form action="{{ route($portalRouteBase . '.hoa-don.index') }}" method="GET" id="invoiceFilterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-md-4 col-xl-3">
                            <div class="d-flex flex-wrap gap-2 justify-content-xl-end">
                                ...
                                <a href="{{ route($portalRouteBase . '.hoa-don.index') }}" class="btn btn-light border rounded-3">
                                    Đặt lại
                                </a>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex gap-2">
                                            <a href="{{ route($portalRouteBase . '.hoa-don.show', $hoaDon->hoaDonId) }}"
                                                class="btn btn-sm btn-light border rounded-circle action-btn"
                                                title="Xem chi tiết">
                                                <i class="fas fa-eye text-primary"></i>
                                            </a>
                                            <a href="{{ route($portalRouteBase . '.hoa-don.print', $hoaDon->hoaDonId) }}"
                                                target="_blank"
                                                class="btn btn-sm btn-light border rounded-circle action-btn"
                                                title="In hóa đơn">
