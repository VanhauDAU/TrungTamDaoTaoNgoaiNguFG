...
@section('content')
    ...
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route($portalRouteBase . '.dang-ky.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <form action="{{ route($portalRouteBase . '.dang-ky.store') }}" method="POST" class="row g-4">
                    @csrf
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <a href="{{ route($portalRouteBase . '.dang-ky.index') }}" class="btn btn-light">Hủy</a>
