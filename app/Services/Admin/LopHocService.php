...
class LopHocService implements LopHocServiceInterface
{
    ...
    public function getList(Request $request): array
    {
        ...
        if ($request->filled('khoaHocId'))   $query->where('khoaHocId', $request->khoaHocId);
        if ($request->filled('coSoId'))       $query->where('coSoId', $request->coSoId);
        if ($request->filled('namBatDau'))    $query->whereYear('ngayBatDau', $request->namBatDau);
        if ($request->filled('thangBatDau'))  $query->whereMonth('ngayBatDau', $request->thangBatDau);
